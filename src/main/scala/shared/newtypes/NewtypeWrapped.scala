...
/** Simple variant of [[Newtype]] that provides an `apply` builder.
  ...
  *
  * // Initializing val name: FullName = FullName("Alexandru Nedelcu") //
  * Extracting the value when a string is needed: val nameStr: String =
  * name.value assert(nameStr === "Alexandru Nedelcu")
  *
